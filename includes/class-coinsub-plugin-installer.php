<?php
/**
 * Coinsub - Required Plugin Auto-Installer
 * 
 * Automatically installs and activates required plugins that are bundled with Coinsub.
    ...
    public static function check_required_plugins_status() {
        ...
        if (!empty($missing_plugins)) {
            ...
            <div class="notice notice-error">
                <p><strong>⚠️ Coinsub - Required Plugin Missing</strong></p>
                ...
                <p><em>Coinsub requires this plugin for security - it ensures users verify their email addresses.</em></p>
            </div>
            <?php
        }
    }
